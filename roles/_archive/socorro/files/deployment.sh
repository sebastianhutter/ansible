...
# source: https://raw.githubusercontent.com/mozilla/socorro/master/scripts/deploy.sh
...
# need to run psql as sudo ... or else auth fails
#psql -U postgres -h localhost -l | grep breakpad > /dev/null
# added by sebastian, 2014-06-22
sudo -u postgres -l | grep breakpad > /dev/null
if [ $? != 0 ]; then
